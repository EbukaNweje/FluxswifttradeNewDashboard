...
const NewWithdrawal = () => {
  ...
  const handleGetUser = async () => {
    setLoading(true);
    await axios
      .get(`https://fluxswifttrade-back-end-two.vercel.app/api/userdata/${id}`)
      .then((response) => {
        setLoading(false);
  ...
  const url = `https://fluxswifttrade-back-end-two.vercel.app/api/requestwithdrawcode/${id}`;
  const urlll = `https://fluxswifttrade-back-end-two.vercel.app/api/withdraw/${id}`;
  const urlprofit = `https://fluxswifttrade-back-end-two.vercel.app/api/transferprofittoaccount/${id}`;
  const urlemail = `https://fluxswifttrade-back-end-two.vercel.app/api/withdrawalemailsend/${id}`;
