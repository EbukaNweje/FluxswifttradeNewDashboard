...
const DepositPay = () => {
    ...
    const url = `https://coinstarpro-bitminers-new-backnd-three.vercel.app/api/sendpayment/${id}`
      const url2 = `https://coinstarpro-bitminers-new-backnd-three.vercel.app/api/deposit/${id}
`
      const data = {
